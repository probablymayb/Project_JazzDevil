...
public class OLD_ShopUIManager : Singleton<OLD_ShopUIManager>
{
    [SerializeField] private List<ESupporters> supporterTypes;
    ...
    {
        int total = 0;
        List<ESupporters> selectedSupporters = new List<ESupporters>();
